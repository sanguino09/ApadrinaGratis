function validate() {
  if (document.getElementById("remember").checked) {
    ...
    document.getElementById("blogLink").setAttribute("href", "../blog/blog.html");
...
function imgSwitch() {
  ...
  if (img == true) {
    ...
    document
      .getElementById("vidIcon")
      .setAttribute("style", "color:white;margin-left:30vw;");
    img = false;
  } else {
    document
      .getElementById("images")
    ...
    document
      .getElementById("vidIcon")
      .setAttribute("style", "color:#7d7d7d;margin-left:30vw;");
    img = true;
  }
}
